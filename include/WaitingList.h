...
public:
    void AddStudent(queue<Student>& students); // Takes student object to add to queue

    void RemoveStudent(); // Removes a student from the front of the queue

    void DisplayWaiting(queue<Student> students); // This should create a copy of the original queue so we don't accidentally destroy the actual queue displaying the data
