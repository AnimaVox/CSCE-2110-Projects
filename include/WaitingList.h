...
public:
    ...
    void DisplayWaiting(const Student& student) const; // This should create a copy of the original queue so we don't accidentally destroy the actual queue displaying the data
