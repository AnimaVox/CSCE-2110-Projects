 ...
 *
 * Requirement covered: "A queue must be used for waiting lists."
 * This is a CUSTOM linked-list-based queue (no STL <queue> used), so the
 * underlying data structure and its Big-O behavior are fully our own work
 * and easy to explain/demonstrate.
 *
 * Design:
